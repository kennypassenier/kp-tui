...
//!
//! Kenny first picked **Sparks behind** for this screen and then, seeing
//! it built, took it back: *"het dashboard mag wel het oude Homelab Rust
//! dashboard zijn, vind ik toch beter."* So this is homelab's own
//! four-panel layout again — the host mesh, the capacity panel, the stack
//! table and the transfers. The direction cost 43 lines and is gone; what
//! stayed from that day is the crate work under it.
